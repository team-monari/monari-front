  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        ...
        <meta name="description" content="내가 참여한 수업" />
      </Head>
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center mb-8">
              <div className="flex items-center gap-4">
                <h1 className="text-2xl font-bold">내가 참여한 수업</h1>
              </div>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-50 rounded-full">
                          ...
                          <span className="text-sm text-gray-600">{lesson.locationName}</span>
                          <span className="text-sm text-gray-600">({regionToKorean[lesson.region]})</span>
                        </div>
                      </div>
                    </Link>
                  ))}
